...
if __name__ == '__main__':
    ...
    print(utils_state)
    news_entities_dict = get_entities(os.path.join(data_path, 'train', 'news.tsv'), output_path)
    generate_entity_embedding(news_entities_dict, os.path.join(data_path, 'train', 'entity_embedding.vec'), os.path.join(data_path, 'valid', 'entity_embedding.vec'), os.path.join(data_path, 'test', 'entity_embedding.vec'), os.path.join(output_path, 'entity_embedding.npy'))
